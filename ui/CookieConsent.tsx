...
const CookieConsent = (props: Props) => {
    ...
    return (
        <section className="bg-white border shadow-md border-neutral-800 bottom-[5%] dark:bg-neutral-950 dark:border-neutral-800 fixed md:max-w-xl md:flex md:gap-x-4 md:items-center mx-auto p-4 rounded-3xl">
