...
const CookieConsent = (props: Props) => {
    ...
    return (!visible ? null : (<section className="bg-white z-50 border shadow-md border-neutral-800 bottom-[5%] dark:bg-neutral-950 dark:border-neutral-800 fixed md:max-w-xl md:flex md:gap-x-4 md:items-center mx-auto p-4 rounded-3xl">
        <div className="flex items-center gap-x-4">
            <span className="inline-flex p-2 text-neutral-500 rounded-lg shrink-0 dark:bg-neutral-800 bg-neutral-100/80">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">We use cookies to ensure that we give you the best experience on our website such as login and sign up ability. <Link href={'/privacy'} className="text-yellow-600 hover:underline "><strong>Read cookies policies</strong></Link>. </p>
        </div>
