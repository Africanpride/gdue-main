...
<>
    <div className="max-w-7xl mx-auto  md:p-8  border border-gray-200 dark:border-neutral-700/30 rounded-3xl space-y-6" >
        ...
        <section className="">
            ...
            <p>GDUE does not sell or rent your personal information to third parties. We may share your information in the following circumstances:</p>
            <ul className="list-disc list-inside space-y-3 indent-[2%]">
        ...
        <section className="">
            ...
            <p>GDUE may update this Privacy Policy from time to time. We will notify you of any significant changes by posting the new Privacy Policy on our website. Your continued use of our services after such changes constitutes your acceptance of the new Privacy Policy.</p>
        </section>
