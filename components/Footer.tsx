...
const Footer = () => {
  ...
  return (
    <footer className="mt-auto w-full  relative ">
      ...
      <div className="max-w-[85rem] pb-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div
          className="pt-16 mt-5  grid grid-cols-2 
    md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10"
        >
          <div className="col-span-full hidden lg:col-span-2 lg:block space-y-4">
            ...
            <p className="mt-3 text-md sm:text-sm text-gray-600 dark:text-neutral-400 capitalize">
              &copy; {currentYear} Ghanaian Diaspora Union   in Europe. (GDUE)
            </p>
            <p className="text-sm max-w-md font-thin">
          ...
          <div className="sm:flex sm:justify-between sm:items-center">
            <div className="flex items-center gap-x-3">
              ...
              <div className="hs-dropdown [--placement:top-left] relative inline-flex">
                ...
                <div
                  className="hs-dropdown-menu w-40 transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden z-10 bg-white shadow-md rounded-lg p-2 dark:bg-neutral-800 dark:border dark:border-neutral-700/30 dark:divide-neutral-700"
